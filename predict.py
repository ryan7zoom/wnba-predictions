...
def build_report():
    ...
    for g in games:
        ...
        home_recent_defense = build_recent_defense_note(get_team_recent_defense(home_id), home_stats, g["away_team_name"])
        away_recent_defense = build_recent_defense_note(get_team_recent_defense(away_id), away_stats, g["home_team_name"])
